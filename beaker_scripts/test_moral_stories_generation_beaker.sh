...
EXPT_FILE=./test_moral_stories_generation_beaker.yml
...
TASKS=( action__story_gen )  # for example
SPLITS=( norm_distance )  # for example
MODEL_TYPES=( bart )  # for example
      ...
      do
        ...
        do
          ...
          do
            ...
            export DESC="EVAL-$TASK_NAME-$SPLIT_NAME-$GROUP_ID"
            expt=$(beaker experiment create --workspace AI2/moral_stories_v2 --file ${EXPT_FILE})
          done
        done
      done
    done
